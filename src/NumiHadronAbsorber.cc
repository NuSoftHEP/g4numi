...
void NumiDetectorConstruction::ConstructHadronAbsorber()
{
  ...
  HadrBox = new G4PVPlacement(zrot, pos, nam, HadrBox_log, pvTUNE, false, 0,NumiData->pSurfChk);//(rotation, G4ThreeVector, name, logical volume, mother, boolean operators, copy number)
  ...
  for(G4int ii = 0;ii<10;ii++){
    ...
    volName.append(no);
    blockPos = G4ThreeVector(CoreX_pos, CoreY_pos, CoreZ_pos);
    new G4PVPlacement(0, StlholePosL, Stlhole_log, "Stlhole", BLK_log[ii], false, 0,NumiData->pSurfChk);
    new G4PVPlacement(0, StlholePosR, Stlhole_log, "Stlhole", BLK_log[ii], false, 0,NumiData->pSurfChk);
  ...
  for (G4int ii=0;ii<8;ii++){
    ...
    if(ii==0){
      ...
      new G4PVPlacement(0, slabpos1, volName, stl_slab1_lv, HadrBox, false, 0,NumiData->pSurfChk);
      ...
      new G4PVPlacement(0, slabpos2, volName, stl_slab2_lv, HadrBox, false, 0,NumiData->pSurfChk);
      ...
      new G4PVPlacement(0, slabpos3, volName, stl_slab3_lv, HadrBox, false, 0,NumiData->pSurfChk);
      ...
      new G4PVPlacement(0, slabpos4, volName, stl_slab4_lv, HadrBox, false, 0,NumiData->pSurfChk);
      ...
      new G4PVPlacement(0, slabpos5, volName, stl_slab5_lv, HadrBox, false, 0,NumiData->pSurfChk);
    }
  }
  ...
  new G4PVPlacement(0, slabpos5, volName, stl_slabL_lv, HadrBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, slabpos6, volName, stl_slabR_lv, HadrBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "conc_BLK", BLK_log[90], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "conc_BLK", BLK_log[91], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "conc_BLK", BLK_log[92], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "topstl1_BLK", BLK_log[93], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "topstl2_BLK", BLK_log[94], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  blockPos = G4ThreeVector(81*in + conc_width/2.0, -in - Al_height/2.0 - 4*bb_height + conc_height + 18.22*in/2.0, -NumiData->HadrBox_length/2.0 + conc_length/2.0);
  new G4PVPlacement(0, blockPos, "topstl3_BLK", BLK_log[95], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "topstl4_BLK", BLK_log[96], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "topstl5_BLK", BLK_log[97], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  blockPos = G4ThreeVector(3*bb_width/2.0 + 2*9.1*in/2.0, -NumiData->HadrBox_height/2.0 + conc_height + 18.22*in + 30*in/2.0, -NumiData->HadrBox_length/2.0 + 4*bb_length/2.0);
  new G4PVPlacement(0, blockPos, "topstl6_BLK", BLK_log[98], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "topstl7_BLK", BLK_log[99], HadrBox, false, 0,NumiData->pSurfChk);
  ...
  nam = "ConcShield";
  ShldBox = new G4PVPlacement(zrot, shldpos, nam, ShldBox_log, pvTUNE, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK0", CShld_log[0], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  blockPos = G4ThreeVector(-1/2.0*A_height-(A_width+B_width)/2.0, -NumiData->HadrBox_height/2.0+B_height/2.0, -CShld_length/2.0+B_length);
  new G4PVPlacement(0, blockPos, "CShld_BLK1", CShld_log[1], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK2", CShld_log[2], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK3", CShld_log[3], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK4", CShld_log[4], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK5", CShld_log[5], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  blockPos = G4ThreeVector(-1/2.0*D_width-1/2.0*C_width, -NumiData->HadrBox_height/2.0+C_height/2.0, -CShld_length/2.0+C_length/2.0);
  new G4PVPlacement(0, blockPos, "CShld_BLK6", CShld_log[6], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK7", CShld_log[7], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  blockPos = G4ThreeVector(-1/2.0*D_width-1/2.0*C_width, -NumiData->HadrBox_height/2.0+C_height+A_width+C_height/2.0, -CShld_length/2.0+C_length/2.0);
  new G4PVPlacement(0, blockPos, "CShld_BLK8", CShld_log[8], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK9", CShld_log[9], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK10", CShld_log[10], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK11", CShld_log[11], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_BLK12", CShld_log[12], ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, "CShld_stl,BLK", CShld_stl_log, ShldBox, false, 0,NumiData->pSurfChk);
  ...
  new G4PVPlacement(0, blockPos, CShld_log[15], "air_BLK15", CShld_log[2], false, 0,NumiData->pSurfChk);
