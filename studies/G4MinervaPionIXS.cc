...
// #include "G4ping.hh"
 ...
 const G4double G4MinervaPionIXS::he_in[38] =  { 
 ...
 const G4double G4MinervaPionIXS::be_m_t[38] = {
 ...
 const G4double G4MinervaPionIXS::be_m_in[38] = { 
 ...
 const G4double G4MinervaPionIXS::c_m_in[39] = {
 ...
 const G4double G4MinervaPionIXS::n_m_in[39] = {
 ...
 const G4double G4MinervaPionIXS::al_m_t[31] = { 
 ...
 const G4double G4MinervaPionIXS::e4[32] = {
  0.02, 0.04, 0.06, 0.08, 0.10, 0.12, 0.14, 0.16, 0.18, 0.20, 0.22, 0.25, 0.30, 0.35, 0.40, 
  0.45, 0.50, 0.55, 0.60, 0.70, 0.80, 0.90,    1,    2,    3,    5,   10,   20,   50,  100,
   500, 1000};

 const G4double G4MinervaPionIXS::fe_m_t[32] = {1175, 1363, 1670, 1950, 2050, 2040, 1975, 1886, 1834, 1773, 1720, 1635, 1474, 1380, 1269, 1225, 1182, 1162, 1159, 1162, 1178, 1190, 1197, 1102, 1135,  975,  945,  925,  905,  905,  905,  905};
 const G4double G4MinervaPionIXS::fe_m_in[32] = {625, 725,   910, 1180, 1275, 1250, 1200, 1150, 1100, 1040,  995,  925,  825,  810,  780,  760,  745,  740,  740,  740,  750,  760,  765,  690,  660,  635,  615,  600,  585,  585,  585,  585};
 const G4double G4MinervaPionIXS::fe_p_t[25] =  {330, 575,  1010, 1500, 1837, 1875, 1820, 1751, 1691, 1636, 1690, 1450, 1396, 1305, 1219, 1190, 1148, 1138, 1134, 1144, 1163, 1175, 1183, 1198, 1135};
 const G4double G4MinervaPionIXS::fe_p_in[25] = {210, 410,   707, 1010, 1125, 1150, 1100, 1070, 1010,  960,  920,  776,  780,  760,  750,  740,  720,  725,  725,  730,  740,  750,  755,  690,  660};
 const G4double G4MinervaPionIXS::cu_m_t[32] = {1400, 1600, 1875, 2088, 2200, 2220, 2175, 2125, 2075, 2012, 1950, 1855, 1670, 1530, 1430, 1370, 1315, 1315, 1315, 1330, 1345, 1360, 1365, 1250, 1185, 1128, 1070, 1035, 1010, 1010, 1010, 1010};
 const G4double G4MinervaPionIXS::cu_m_in[32] = {725, 840,  1020, 1200, 1295, 1300, 1267, 1240, 1213, 1175, 1125, 1042,  950,  900,  860,  840,  830,  832,  835,  840,  850,  860,  865,  785,  735,  705,  680,  650,  630,  630,  630,  630};
 const G4double G4MinervaPionIXS::cu_p_t[25] =  {355, 605,  1120, 1630, 1940, 2010, 2010, 1980, 1925, 1895, 1830, 1730, 1585, 1490, 1400, 1340, 1290, 1290, 1290, 1310, 1330, 1345, 1350, 1240, 1185};
 const G4double G4MinervaPionIXS::cu_p_in[25] = {230, 425,  780,  1025, 1155, 1190, 1190, 1180, 1125, 1100, 1050, 1000,  900,  870,  835,  815,  810,  812,  815,  825,  840,  850,  855,  780,  735};

 const G4double G4MinervaPionIXS::e5[34] = {
 ...
 const G4double G4MinervaPionIXS::mo_m_t[34] = {2430, 2610, 2710, 2790, 2880, 2940, 2965, 2970, 2970, 2920, 2840, 2720, 2570, 2500, 2365, 2200, 2050, 1926, 1825, 1768, 1749, 1750, 1778, 1789, 1808, 1690, 1645, 1530, 1492, 1450, 1425, 1425, 1425, 1425};
 const G4double G4MinervaPionIXS::mo_m_in[34] = {925, 1125, 1250, 1375, 1500, 1600, 1680, 1750, 1770, 1730, 1660, 1580, 1500, 1450, 1330, 1250, 1190, 1140, 1100, 1075, 1075, 1070, 1088, 1095, 1110, 1035, 1005,  940,  917,  880,  860,  860,  860,  860};
 const G4double G4MinervaPionIXS::mo_p_t[27] =  {410,  730, 1110, 1530, 1920, 2200, 2385, 2520, 2600, 2630, 2575, 2470, 2320, 2285, 2185, 2053, 1945, 1852, 1776, 1719, 1710, 1716, 1746, 1759, 1778, 1675, 1645};
 const G4double G4MinervaPionIXS::mo_p_in[27] = {270,  540,  825,  975, 1140, 1285, 1400, 1480, 1555, 1580, 1525, 1470, 1360, 1340, 1255, 1160, 1120, 1085, 1060, 1045, 1045, 1045, 1065, 1075, 1090, 1025, 1005};
 const G4double G4MinervaPionIXS::cd_m_t[34] = {3060, 3125, 3170, 3220, 3255, 3280, 3290, 3260, 3270, 3200, 3120, 3080, 3090, 2920, 2810, 2640, 2362, 2230, 2115, 2050, 2020, 2025, 2040, 2070, 2100, 1900, 1795, 1740, 1675, 1645, 1625, 1620, 1620, 1620};
 const G4double G4MinervaPionIXS::cd_m_in[34]= {1025, 1275, 1440, 1625, 1740, 1800, 1880, 1920, 1980, 1920, 1850, 1810, 1720, 1650, 1560, 1450, 1330, 1290, 1245, 1210, 1200, 1200, 1205, 1205, 1230, 1130, 1085, 1060, 1000,  985,  975,  970,  970,  970};
 const G4double G4MinervaPionIXS::cd_p_t[28] =  {455,  780, 1170, 1700, 2120, 2400, 2600, 2720, 2820, 2840, 2800, 2760, 2720, 2640, 2560, 2450, 2252, 2130, 2035, 1985, 1970, 1975, 2005, 2035, 2070, 1880, 1795, 1740};
 const G4double G4MinervaPionIXS::cd_p_in[28] = {310,  580,  880, 1060, 1270, 1400, 1530, 1610, 1660, 1680, 1640, 1600, 1560, 1500, 1430, 1330, 1280, 1230, 1200, 1180, 1170, 1175, 1180, 1180, 1210, 1120, 1085, 1060};

 const G4double G4MinervaPionIXS::e6[35] = {
  0.02, 0.04, 0.05, 0.06, 0.07, 0.08, 0.09, 0.10, 0.12, 0.14, 0.16, 0.18, 0.20, 0.22, 0.25,  
  0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.70, 0.80, 0.90,    1,    2,    3,    5,   10,   
    20,   50,  100,  500, 1000};

 const G4double G4MinervaPionIXS::sn_m_t[35] =  {3000, 3180, 3250, 3300, 3300, 3410, 3470, 3450, 3410, 3350, 3280, 3200, 3120, 3050, 2900, 2630, 2500, 2325, 2190, 2100, 2060, 2055, 2055, 2055, 2067, 2085, 2000, 1900, 1835, 1770, 1720, 1700, 1695, 1695, 1695};
 const G4double G4MinervaPionIXS::sn_m_in[35] = {1050, 1350, 1520, 1650, 1800, 1980, 2070, 2120, 2090, 2050, 1980, 1920, 1830, 1770, 1670, 1500, 1435, 1350, 1300, 1230, 1220, 1235, 1235, 1235, 1237, 1240, 1160, 1120, 1090, 1065, 1040, 1020, 1015, 1015, 1015};
 const G4double G4MinervaPionIXS::sn_p_t[29] =  { 465,  800, 1200, 1760, 2170, 2480, 2730, 2885, 2970, 2980, 2970, 2890, 2840, 2790, 2620, 2450, 2335, 2205, 2080, 2020, 2010, 1990, 1990, 2015, 2030, 2045, 1980, 1890, 1835};
 const G4double G4MinervaPionIXS::sn_p_in[29] = { 315,  590,  880, 1220, 1460, 1580, 1700, 1770, 1810, 1810, 1800, 1730, 1680, 1630, 1530, 1400, 1335, 1270, 1210, 1180, 1190, 1190, 1190, 1205, 1210, 1210, 1150, 1115, 1090};
 const G4double G4MinervaPionIXS::w_m_t[35] =   {5200, 5115, 5025, 4975, 4900, 4850, 4780, 4725, 4600, 4490, 4355, 4255, 4125, 4040, 3830, 3580, 3330, 3110, 2955, 2860, 2852, 2845, 2885, 2900, 2915, 2940, 2800, 2660, 2570, 2490, 2460, 2425, 2420, 2420, 2420};
 const G4double G4MinervaPionIXS::w_m_in[35] =  {1450, 1850, 2100, 2350, 2550, 2700, 2825, 2900, 2850, 2750, 2630, 2525, 2400, 2300, 2200, 2070, 1880, 1770, 1715, 1680, 1680, 1680, 1685, 1690, 1700, 1720, 1635, 1560, 1530, 1460, 1440, 1410, 1410, 1410, 1410};
 const G4double G4MinervaPionIXS::w_p_t[30] =   { 480,  900, 1500, 2350, 3020, 3420, 3650, 3775, 3875, 3830, 3750, 3700, 3630, 3550, 3550, 3290, 3070, 2890, 2840, 2730, 2725, 2720, 2770, 2805, 2828, 2865, 2770, 2640, 2570, 2490};
 const G4double G4MinervaPionIXS::w_p_in[30] =  { 325,  680,  990, 1500, 1850, 2150, 2250, 2300, 2350, 2330, 2280, 2230, 2200, 2120, 2130, 1900, 1780, 1670, 1635, 1600, 1602, 1605, 1610, 1615, 1630, 1660, 1620, 1550, 1530, 1460};

 const G4double G4MinervaPionIXS::e7[35] = {
  0.02, 0.04, 0.05, 0.06, 0.07, 0.08, 0.09, 0.10, 0.12, 0.14, 0.16, 0.18, 0.20, 0.22, 0.25, 
  0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.60, 0.70, 0.80, 0.90,    1,    2,    3,    5,   10,
    20,   50,  100,  500, 1000};

 const G4double G4MinervaPionIXS::pb_m_t[35] = {
 ...
 const G4double G4MinervaPionIXS::pb_m_in[35] = {
 ...
 const G4double G4MinervaPionIXS::pb_p_t[30] = { 
 ...
 const G4double G4MinervaPionIXS::pb_p_in[30] = { 
 ...
 const G4double G4MinervaPionIXS::u_m_t[35] =   {
 ...
 const G4double G4MinervaPionIXS::u_m_in[35] =  {
 ...
 const G4double G4MinervaPionIXS::u_p_t[30] =   { 
 ...
 const G4double G4MinervaPionIXS::u_p_in[30] =  { 
                     ...
                     G4double /*AA*/, G4double /*temperature*/)
{
  ...
  if(!ok) 
  {
    throw G4HadronicException(__FILE__, __LINE__,
                       	"Call to G4MinervaPionIXS failed.");
  }
  ...
  {
    throw G4HadronicException(__FILE__, __LINE__,
      "Called G4MinervaPionIXS outside parametrization");
  }
  G4int Z1, Z2;
  ...
  //  G4cout<<"scaleVal pion IXS "<<scaleVal<<" "<<scaleVal*result<<G4endl;
  return scaleVal*result;
 }
